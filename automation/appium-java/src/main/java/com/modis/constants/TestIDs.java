...
public class TestIDs {
    ...
    public static final String SEND_PHOTO_FRIEND_PREFIX = "send_photo_friend_";
    ...
    public static final String FEED_POST_ITEM_PREFIX = "feed_post_item_";
    public static final String FEED_POST_IMAGE_PREFIX = "feed_post_image_";
    public static final String FEED_COMMENT_BUTTON_PREFIX = "feed_comment_button_";
    public static final String FEED_EMOJI_PREFIX = "feed_emoji_";
    ...
    public static final String FRIEND_ITEM_PREFIX = "friend-item-";
    public static final String FRIEND_AVATAR_PREFIX = "friend-avatar-";
    public static final String FRIEND_NAME_PREFIX = "friend-name-";
    public static final String FRIEND_UNFRIEND_PREFIX = "friend-unfriend-";
    public static final String FRIEND_REQUEST_ITEM_PREFIX = "friend_request_item_";
    ...
    public static final String MESSAGE_CONVERSATION_ITEM_PREFIX = "message_conversation_item_";
    ...
    public static final String CONVERSATION_MESSAGE_PREFIX = "conversation_message_";
    ...
    public static final String ALL_IMAGES_ITEM_PREFIX = "all_images_grid_item_";
    ...
    public static final String SEARCH_RESULT_ITEM_PREFIX = "search_result_item_";
    public static final String SEARCH_RESULT_ADD_BUTTON_PREFIX = "search_result_add_button_";
    public static final String SEARCH_EMPTY_STATE = "search_empty_state";
    public static final String EMOJI_PICKER = "emoji_picker";
    public static final String EMOJI_BUTTON_PREFIX = "emoji_button_";
    public static final String EMOJI_CATEGORY_PREFIX = "emoji_category_";
    ...
    public static final String FIELD_ERROR_PREFIX = "field_error_";
