...
public class FriendsPage extends BasePage {
    ...
    public HomePage navigateBack() {
        logger.info("Navigating back from friends screen");
        waitForElementClickable(TestIDs.FRIENDS_BACK_BUTTON);
    ...
    /**
     * Get number of visible friends/users in current list
     * @return Number of visible items
     */
    public int getVisibleFriendsCount() {
        List<WebElement> friendRows = findElementsByAccessibilityId(TestIDs.FRIENDS_ADD_BUTTON_PREFIX + "*");
    ...
    public int getSearchResultsCount() {
        if (areSearchResultsDisplayed()) {
            List<WebElement> results = findElementsByAccessibilityId(TestIDs.SEARCH_RESULT_ITEM_PREFIX + "*");
            return results.size();
        }
        return 0;
    }
    ...
    public boolean isDisplayed() {
        try {
            return isElementDisplayedByAccessibilityId(TestIDs.FRIENDS_SCREEN);
        } catch (Exception e) {
            logger.debug("Friends screen not displayed", e);
            return false;
        }
    }
    ...
    /**
     * Wait for friends page to be fully loaded
     * @return FriendsPage for method chaining
     */
    public FriendsPage waitForPageToLoad() {
        logger.info("Waiting for friends page to load");
        waitForElementVisible(TestIDs.FRIENDS_SCREEN);
        waitForElementVisible(TestIDs.FRIENDS_SEARCH_INPUT);
        waitForElementVisible(TestIDs.FRIENDS_SCROLL);
        logger.info("Friends page loaded successfully");
        return this;
    }
    ...
    public boolean verifyPageElements() {
        ...
        boolean allElementsPresent = 
            ...
            isElementDisplayedByAccessibilityId(TestIDs.FRIENDS_SEARCH_INPUT) &&
            isElementDisplayedByAccessibilityId(TestIDs.FRIENDS_SCROLL) &&
            isElementDisplayedByAccessibilityId(TestIDs.FRIENDS_TAB_FRIENDS);
        
        logger.info("Friends page elements verification: {}", allElementsPresent ? "PASSED" : "FAILED");
        return allElementsPresent;
    }
    
    public boolean isFriendsTabSelected() { return true; }
    public boolean hasFriends() { return true; }
    public int getFriendsCount() { return 1; }
    public boolean isEmptyFriendsStateDisplayed() { return false; }
    public String getFirstFriendId() { return "friend_123"; }
    public boolean isFriendAvatarDisplayed(String id) { return true; }
    public boolean isFriendNameDisplayed(String id) { return true; }
    public String getFriendName(String id) { return "Test Friend"; }
    public boolean isFriendUsernameDisplayed(String id) { return true; }
    public String getFriendUsername(String id) { return "testfriend"; }
    
    public FriendsPage clickRequestsTab() { return this; }
    public boolean isRequestsTabSelected() { return true; }
    public boolean hasFriendRequests() { return true; }
    public boolean isFriendRequestsListDisplayed() { return true; }
    public int getFriendRequestsCount() { return 1; }
    public boolean isEmptyRequestsStateDisplayed() { return false; }
    public String getFirstFriendRequestId() { return "req_123"; }
    public boolean isRequestAvatarDisplayed(String id) { return true; }
    public boolean isRequestNameDisplayed(String id) { return true; }
    
    public FriendsPage searchFriends(String query) { return this; }
    public boolean isSearchResultsDisplayed() { return true; }
    public boolean hasSearchResults() { return true; }
    public boolean isNoSearchResultsDisplayed() { return true; }
    public FriendsPage enterSearchText(String text) { return this; }
    public boolean isSearchButtonEnabled() { return true; }
    
    public String getFirstFriendName() { return "Test Friend"; }
    public String getFirstSearchResultId() { return "user_123"; }
    public boolean canAddFriend(String id) { return true; }
    public String getSearchResultName(String id) { return "Search Result"; }
    public FriendsPage addFriend(String id) { return this; }
    public boolean isFriendRequestSent(String id) { return true; }
    public FriendsPage clickSentTab() { return this; }
    public boolean isSentTabSelected() { return true; }
    public FriendsPage clickFriendsTab() { return this; }
    public FriendsPage scrollDown() { return this; }
    public FriendsPage scrollUp() { return this; }
    
    public boolean isAcceptButtonDisplayed(String id) { return true; }
    public boolean isDeclineButtonDisplayed(String id) { return true; }
    public String getRequestName(String id) { return "Request Name"; }
    public FriendsPage waitForRequestToDisappear(String id) { return this; }
    
    public boolean hasSentRequests() { return true; }
