...
public class AuthenticationTests extends BaseTest {
    ...
    @Test(priority = P_LOADING_SCREEN, groups = {"authentication", "flow", "smoke", "regression"},
            description = "Verify Loading/Welcome screen appears first")
    ...
    @Test(priority = P_LOGIN_VALID_FLOW, groups = {"authentication", "smoke", "regression"},
            description = "Valid login should navigate to Home page")
    public void testLoginSuccessfully() {
        LoginPage loginPage = navigateToLoginFromLoading();
        Map<String, Object> validUser = testDataReader.getValidLoginCredentials().get(0);
        ...
        Assert.assertTrue(homePage.isTopbarAvatarDisplayed(), "Avatar should be visible after login");
