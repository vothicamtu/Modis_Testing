@echo off
REM Modis Load Test Runner Script for Windows
REM Usage: run-load-test.bat [users] [ramp_up] [duration]
...
set RESULT_FILE=results\load-test-%timestamp%.jtl
set REPORT_DIR=reports\load-test-%timestamp%
