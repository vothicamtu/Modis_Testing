...
/**
 * Java helper for test data generation and manipulation in JMeter tests
 * Replaces the Groovy DataHelper.
 */
public class DataHelper {
    ...
    /**
     * Generate random reaction emoji
     */
    ...
    /**
     * Create JSON request body for user registration
     */
    ...
    /**
     * Create JSON request body for sending message
     */
    ...
    /**
     * Create JSON request body for photo upload
     */
    ...
    /**
     * Create JSON request body for friend request
     */
    ...
    public static String extractUserId(String responseData) {
        try {
            ...
            if (jsonResponse.has("user") && jsonResponse.get("user").has("id")) return jsonResponse.get("user").get("id").asText();
            if (jsonResponse.has("data") && jsonResponse.get("data").has("id")) return jsonResponse.get("data").get("id").asText();
    ...
    /**
     * Generate random delay for realistic user behavior
     */
    ...
    /**
     * Generate realistic timestamp within last N days
     */
